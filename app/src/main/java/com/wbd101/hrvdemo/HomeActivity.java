...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView exam_date = (TextView)findViewById(R.id.date);
        display = "Exam Date: "+ date;
        exam_date.setText(display);
        ...
        survey1_button.setOnClickListener(v ->{
            ...
            survey_intent.putExtra("date", date);
            survey_intent.putExtra("prevDate", prevDate);
            survey_intent.putExtra("nextDate", nextDate);

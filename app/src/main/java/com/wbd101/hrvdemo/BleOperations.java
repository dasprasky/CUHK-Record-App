...
//        fatigueBar = (ProgressBar)findViewById(R.id.progressBar4);
        fatigue = (TextView)findViewById(R.id.fatigue_value);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                String age = String.format("%d", sp.getInt("age",0));

                String hr_filename = id+"_"+age+"/hr/" + timeStamp.format(dNow.getTime()) + ".csv";
                String resp_filename = id+"_"+age+"/resp/" + timeStamp.format(dNow.getTime()) + ".csv";
                String hrv_filename = id+"_"+age+"/hrv/" + timeStamp.format(dNow.getTime()) + ".csv";

                upload_files(transferUtility, hr_filename, hr_csv);
                upload_files(transferUtility, resp_filename, resp_csv);
                upload_files(transferUtility, hrv_filename, hrv_csv);
        ...
        void upload_files(TransferUtility transferUtility, String filename, String filename_in_device){
            TransferObserver transferObserver = transferUtility.upload("cuhk-wbd-android-files",filename, new File(filename_in_device), CannedAccessControlList.BucketOwnerRead);
